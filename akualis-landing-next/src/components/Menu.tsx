        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 py-2">
          ...
          <Link
            ...
            className={`flex items-center transition-opacity duration-300 ${
              isScrolledPastThreshold ? 'opacity-100' : 'opacity-0 pointer-events-none'
            }`}
          >
            <Image
          ...
          <ul className="hidden md:flex items-center gap-4 font-semibold">
            <li>
              <a href="#concept" className="menu-item px-3 text-primary">
                Concept
              </a>
            </li>
            <li>
              <a href="#constat" className="menu-item px-3 text-primary">
                Mission
              </a>
            </li>
            <li>
              <a href="#team" className="menu-item px-3 text-primary">
                Equipe
              </a>
            </li>
            <li>
              <a href="#testimonials" className="menu-item px-3 text-primary">
                Témoignages
              </a>
            </li>
            <li>
              <Link href="/blog" className="menu-item px-3 text-primary">
                Blog
              </Link>
            </li>
            <li>
